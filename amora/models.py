...
class ModelConfig:
    ...
    Attributes:
        ...
        cluster_by (List[str]): BigQuery tables can be [clustered](https://cloud.google.com/bigquery/docs/clustered-tables) to colocate related data. Expects a column of a list of columns.
        labels (Dict[str,str]): A dict of labels that can be used as the resource selection
        description (int): A string description of the model, used for documentation
    """
